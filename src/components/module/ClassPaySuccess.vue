...
<script>
  export default {
    data () {
        return {
            data:[
	            {name:'微信',imgName:require('../../assets/imgs/classes/wx.png'),url:'/app/pay/a/course/weixin'},
	            {name:'支付宝',imgName:require('../../assets/imgs/classes/zfb.png'),url:'/app/pay/a/course/zfb'}
            ],
            radata:{},
            payInfo:{},
            courseInfo:{},
         ...
         .then((res)=>{
            if(res.data.status==0){
         	...
         	console.log(res.data.data)
            	...
            	this.payInfo.qrCodeUrl='http://192.168.0.252:86/'+res.data.data.qrCodeUrl;
            }else{
